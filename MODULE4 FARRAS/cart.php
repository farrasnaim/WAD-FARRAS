...
<body>
    ...
    <br></br>
    <h1 class="text-center">WAD Beauty Cart</h1>
    <div class="container" style="margin: 0 auto ; margin-top: 50px ;">
        ...
        ?>
                <tr>
                    ...
                    <td><button onclick="location.href = 'deletefunc.php?id=<?php echo $datacart['id'] ?>' "
        ...
        <p align="center" style="margin-top: 40px"> © 2020 Copyright: <a href="home.php">WAD Beauty</a> </p>
    </div>
